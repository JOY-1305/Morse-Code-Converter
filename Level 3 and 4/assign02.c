...
void code_init(){
    codewords[0].word="Cat";
    codewords[1].word="bat"; 
    codewords[2].word="Pat";
    codewords[3].word="Ill";
    codewords[4].word="sat";
    codewords[5].word="bot";
    codewords[6].word="set";
    ...
    codewords[0].sequence=949471;
    codewords[1].sequence=7489783;  
    codewords[2].sequence=2083063;
    codewords[3].sequence=611918793;
    codewords[4].sequence=149751;
    codewords[5].sequence=59924471;
    codewords[6].sequence=1997303;
...
int32_t update_lives34(int32_t sequence)
{
    int answer =0; 
    int inputIndex=-1;

    for (int i=0; i<CODE_SIZE;i++){   //identifying 
        if (codewords[i].sequence==sequence){
            inputIndex= i;
    ...
    else
    {
        if (inputIndex==-1){
            ...
            printf(":               Wrong! Taking away a life.                :\n");
            printf(":                      You Entered                        :\n");
            printf(":                          %c %s                      \n",codewords[inputIndex].word,codewords[inputIndex].code);
            printf("+---------------------------------------------------------+\n");
        }
        CORRECT_ANSWERS--;
        LOST_LIVES ++;
...
void level_3_display(){
  random_number=rand()%7;
    printf("+---------------------------------------------------------+\n");
    printf(":       Reproduce this character in morse sequence        \n");
    printf(":                           %s                            \n",codewords[random_number].word);
    printf(":                          %s                            \n",codewords[random_number].code);
    printf("+---------------------------------------------------------+\n");
